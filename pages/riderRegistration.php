...
<body>
    ...
    <main>
        ...
        <form action="../actions/insertDriver.php" method="POST" class="formRider" enctype="multipart/form-data">
            <div>
            ...
            <p class="left">Already a driver? <a href="login.php">Login here</a></p>
            <p class="right">Register as user? <a href="userRegistration.php">Click here</a></p>
